...
Constants.antigrief = {
    ...
    damage_entity_threshold_trusted = 200,
...
Constants.audit = {
    ...
    combat_destroy_trusted = 'destroyed %s with weapon/vehicle (owner: %s) — restored', 
    rotate = 'rotated %s (owner: %s)',                            
    flip = 'flipped %s (owner: %s)',                              
    mined_foreign = 'mined %s (owner: %s)',                       
    paste_settings = 'pasted settings onto %s (owner: %s)',       
    fast_transfer = 'fast-transferred items to/from %s (owner: %s)', 
